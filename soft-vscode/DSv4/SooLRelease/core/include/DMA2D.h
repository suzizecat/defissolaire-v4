	...
	namespace core {
		...
		public:
			...
			public:
				...
				bool is_ready() volatile;
				void set_mode(Mode m) volatile;
...
//Instances for peripheral DMA2D
		...
		inline bool DMA2D::is_ready() volatile
		{
		    return ! CR.START;
		}
		
		inline void DMA2D::set_mode(Mode m) volatile
		{
		    CR.MODE = static_cast<uint32_t>(m);
		}
